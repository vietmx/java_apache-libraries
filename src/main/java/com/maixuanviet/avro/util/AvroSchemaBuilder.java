package com.maixuanviet.avro.util;
...
public class AvroSchemaBuilder {
    ...
    public Schema createAvroHttpRequestSchema(){
        ...
        Schema clientIdentifier = SchemaBuilder.record("ClientIdentifier").namespace("com.maixuanviet.avro.model")
                .fields().requiredString("hostName").requiredString("ipAddress").endRecord();

        Schema avroHttpRequest = SchemaBuilder.record("AvroHttpRequest").namespace("com.maixuanviet.avro.model").fields()
