package com.maixuanviet.avro.model;
...
public class AvroHttpRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public com.maixuanviet.avro.model.ClientIdentifier clientIdentifier;
  @Deprecated public java.util.List<CharSequence> employeeNames;
  @Deprecated public com.maixuanviet.avro.model.Active active;
   ...
   */
  public AvroHttpRequest(Long requestTime, com.maixuanviet.avro.model.ClientIdentifier clientIdentifier, java.util.List<CharSequence> employeeNames, com.maixuanviet.avro.model.Active active) {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: requestTime = (Long)value$; break;
    case 1: clientIdentifier = (com.maixuanviet.avro.model.ClientIdentifier)value$; break;
    case 2: employeeNames = (java.util.List<CharSequence>)value$; break;
    case 3: active = (com.maixuanviet.avro.model.Active)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.maixuanviet.avro.model.ClientIdentifier getClientIdentifier() {
   ...
   * @param value the value to set.
   */
  public void setClientIdentifier(com.maixuanviet.avro.model.ClientIdentifier value) {
   ...
   */
  public com.maixuanviet.avro.model.Active getActive() {
    return active;
  }
   ...
   * @param value the value to set.
   */
  public void setActive(com.maixuanviet.avro.model.Active value) {
    this.active = value;
  }
   ...
   */
  public static com.maixuanviet.avro.model.AvroHttpRequest.Builder newBuilder() {
    return new com.maixuanviet.avro.model.AvroHttpRequest.Builder();
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static com.maixuanviet.avro.model.AvroHttpRequest.Builder newBuilder(com.maixuanviet.avro.model.AvroHttpRequest.Builder other) {
    return new com.maixuanviet.avro.model.AvroHttpRequest.Builder(other);
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static com.maixuanviet.avro.model.AvroHttpRequest.Builder newBuilder(com.maixuanviet.avro.model.AvroHttpRequest other) {
    return new com.maixuanviet.avro.model.AvroHttpRequest.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroHttpRequest>
    ...
    private com.maixuanviet.avro.model.ClientIdentifier clientIdentifier;
    private com.maixuanviet.avro.model.ClientIdentifier.Builder clientIdentifierBuilder;
    private java.util.List<CharSequence> employeeNames;
    private com.maixuanviet.avro.model.Active active;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.maixuanviet.avro.model.AvroHttpRequest.Builder other) {
      super(other);
      ...
      if (other.hasClientIdentifierBuilder()) {
        this.clientIdentifierBuilder = com.maixuanviet.avro.model.ClientIdentifier.newBuilder(other.getClientIdentifierBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.maixuanviet.avro.model.AvroHttpRequest other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.requestTime)) {
        this.requestTime = data().deepCopy(fields()[0].schema(), other.requestTime);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.maixuanviet.avro.model.AvroHttpRequest.Builder setRequestTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.maixuanviet.avro.model.AvroHttpRequest.Builder clearRequestTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.maixuanviet.avro.model.AvroHttpRequest.Builder setClientIdentifier(com.maixuanviet.avro.model.ClientIdentifier value) {
     ...
     * @return This builder.
     */
    public com.maixuanviet.avro.model.ClientIdentifier.Builder getClientIdentifierBuilder() {
      if (clientIdentifierBuilder == null) {
        if (hasClientIdentifier()) {
          setClientIdentifierBuilder(com.maixuanviet.avro.model.ClientIdentifier.newBuilder(clientIdentifier));
        } else {
          setClientIdentifierBuilder(com.maixuanviet.avro.model.ClientIdentifier.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.maixuanviet.avro.model.AvroHttpRequest.Builder setClientIdentifierBuilder(com.maixuanviet.avro.model.ClientIdentifier.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.maixuanviet.avro.model.AvroHttpRequest.Builder clearClientIdentifier() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.maixuanviet.avro.model.AvroHttpRequest.Builder setEmployeeNames(java.util.List<CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.maixuanviet.avro.model.AvroHttpRequest.Builder clearEmployeeNames() {
      employeeNames = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.maixuanviet.avro.model.AvroHttpRequest.Builder setActive(com.maixuanviet.avro.model.Active value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.maixuanviet.avro.model.AvroHttpRequest.Builder clearActive() {
      active = null;
    ...
    public AvroHttpRequest build() {
      try {
        ...
        record.requestTime = fieldSetFlags()[0] ? this.requestTime : (Long) defaultValue(fields()[0]);
        if (clientIdentifierBuilder != null) {
          record.clientIdentifier = this.clientIdentifierBuilder.build();
        } else {
          record.clientIdentifier = fieldSetFlags()[1] ? this.clientIdentifier : (com.maixuanviet.avro.model.ClientIdentifier) defaultValue(fields()[1]);
        }
        record.employeeNames = fieldSetFlags()[2] ? this.employeeNames : (java.util.List<CharSequence>) defaultValue(fields()[2]);
        record.active = fieldSetFlags()[3] ? this.active : (com.maixuanviet.avro.model.Active) defaultValue(fields()[3]);
        return record;
      } catch (Exception e) {
